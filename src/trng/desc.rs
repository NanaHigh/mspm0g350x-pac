...
#[doc = "Field `DESC_INSTNUM` reader - Instance Number within the device. This will be a parameter to the RTL for modules that can have multiple instances"]
pub type DescInstnumR = crate::FieldReader;
#[doc = "Field `DESC_FEATUREVER` reader - Feature Set for the module *instance*"]
pub type DescFeatureverR = crate::FieldReader;
#[doc = "Field `DESC_MODULEID` reader - Module Identifier - An internal TI page has been created to request unique module IDs"]
...
#[doc = "`reset()` method sets DESC to value 0x0511_0000"]
