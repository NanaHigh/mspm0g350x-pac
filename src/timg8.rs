...
impl RegisterBlock {
    ...
    #[doc = "0x18bc - Count Direction Register"]
    #[inline(always)]
    pub const fn qdir(&self) -> &Qdir {
        &self.qdir
    }
}
...
#[doc = "Trigger Select"]
pub mod tsel;
#[doc = "QDIR (r) register accessor: Count Direction Register\n\nYou can [`read`](crate::Reg::read) this register and get [`qdir::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@qdir`]
module"]
#[doc(alias = "QDIR")]
pub type Qdir = crate::Reg<qdir::QdirSpec>;
