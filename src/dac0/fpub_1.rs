...
#[doc = "Field `FPUB_1_CHANID` reader - 0 = disconnected. others = connected to channel_ID = CHANID."]
...
#[doc = "Field `FPUB_1_CHANID` writer - 0 = disconnected. others = connected to channel_ID = CHANID."]
