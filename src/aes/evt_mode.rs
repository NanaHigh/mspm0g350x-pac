...
#[doc = "Field `EVT_MODE_EVT1_CFG` reader - Event line mode select for event corresponding to \\[IPSTANDARD.INT_EVENT1\\]"]
...
#[doc = "Field `EVT_MODE_EVT2_CFG` reader - Event line mode select for event corresponding to \\[IPSTANDARD.INT_EVENT2\\]"]
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
#[repr(u8)]
pub enum EvtModeEvt3Cfg {
    #[doc = "0: DISABLE"]
    EvtModeEvt3CfgDisable = 0,
    #[doc = "1: SOFTWARE"]
    EvtModeEvt3CfgSoftware = 1,
    #[doc = "2: HARDWARE"]
    EvtModeEvt3CfgHardware = 2,
}
impl From<EvtModeEvt3Cfg> for u8 {
    #[inline(always)]
    fn from(variant: EvtModeEvt3Cfg) -> Self {
        variant as _
    }
}
impl crate::FieldSpec for EvtModeEvt3Cfg {
    type Ux = u8;
}
impl crate::IsEnum for EvtModeEvt3Cfg {}
#[doc = "Field `EVT_MODE_EVT3_CFG` reader - Event line mode select for event corresponding to \\[IPSTANDARD.INT_EVENT2\\]"]
pub type EvtModeEvt3CfgR = crate::FieldReader<EvtModeEvt3Cfg>;
impl EvtModeEvt3CfgR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Option<EvtModeEvt3Cfg> {
        match self.bits {
            0 => Some(EvtModeEvt3Cfg::EvtModeEvt3CfgDisable),
            1 => Some(EvtModeEvt3Cfg::EvtModeEvt3CfgSoftware),
            2 => Some(EvtModeEvt3Cfg::EvtModeEvt3CfgHardware),
            _ => None,
        }
    }
    #[doc = "DISABLE"]
    #[inline(always)]
    pub fn is_evt_mode_evt3_cfg_disable(&self) -> bool {
        *self == EvtModeEvt3Cfg::EvtModeEvt3CfgDisable
    }
    #[doc = "SOFTWARE"]
    #[inline(always)]
    pub fn is_evt_mode_evt3_cfg_software(&self) -> bool {
        *self == EvtModeEvt3Cfg::EvtModeEvt3CfgSoftware
    }
    #[doc = "HARDWARE"]
    #[inline(always)]
    pub fn is_evt_mode_evt3_cfg_hardware(&self) -> bool {
        *self == EvtModeEvt3Cfg::EvtModeEvt3CfgHardware
    }
}
impl R {
    ...
    #[doc = "Bits 6:7 - Event line mode select for event corresponding to \\[IPSTANDARD.INT_EVENT2\\]"]
    #[inline(always)]
    pub fn evt_mode_evt3_cfg(&self) -> EvtModeEvt3CfgR {
        EvtModeEvt3CfgR::new(((self.bits >> 6) & 3) as u8)
    }
}
impl W {}
