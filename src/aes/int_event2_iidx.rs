...
impl IntEvent2IidxStatR {
    ...
    pub const fn variant(&self) -> Option<IntEvent2IidxStat> {
        match self.bits {
            ...
            3 => Some(IntEvent2IidxStat::IntEvent2IidxStatDma1),
            _ => None,
        }
    }
    #[doc = "NO_INTR"]
    ...
    #[doc = "DMA1"]
    #[inline(always)]
    pub fn is_int_event2_iidx_stat_dma1(&self) -> bool {
        *self == IntEvent2IidxStat::IntEvent2IidxStatDma1
    }
}
impl R {
