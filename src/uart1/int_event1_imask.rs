...
#[doc = "Field `INT_EVENT1_IMASK_RTOUT` reader - Enable UARTOUT Receive Time-Out Interrupt."]
...
#[doc = "Field `INT_EVENT1_IMASK_RTOUT` writer - Enable UARTOUT Receive Time-Out Interrupt."]
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum IntEvent1ImaskRxint {
    #[doc = "0: CLR"]
    IntEvent1ImaskRxintClr = 0,
    #[doc = "1: SET"]
    IntEvent1ImaskRxintSet = 1,
}
impl From<IntEvent1ImaskRxint> for bool {
    #[inline(always)]
    fn from(variant: IntEvent1ImaskRxint) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `INT_EVENT1_IMASK_RXINT` reader - Enable UART Receive Interrupt."]
pub type IntEvent1ImaskRxintR = crate::BitReader<IntEvent1ImaskRxint>;
impl IntEvent1ImaskRxintR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> IntEvent1ImaskRxint {
        match self.bits {
            false => IntEvent1ImaskRxint::IntEvent1ImaskRxintClr,
            true => IntEvent1ImaskRxint::IntEvent1ImaskRxintSet,
        }
    }
    #[doc = "CLR"]
    #[inline(always)]
    pub fn is_int_event1_imask_rxint_clr(&self) -> bool {
        *self == IntEvent1ImaskRxint::IntEvent1ImaskRxintClr
    }
    #[doc = "SET"]
    #[inline(always)]
    pub fn is_int_event1_imask_rxint_set(&self) -> bool {
        *self == IntEvent1ImaskRxint::IntEvent1ImaskRxintSet
    }
}
#[doc = "Field `INT_EVENT1_IMASK_RXINT` writer - Enable UART Receive Interrupt."]
pub type IntEvent1ImaskRxintW<'a, REG> = crate::BitWriter<'a, REG, IntEvent1ImaskRxint>;
impl<'a, REG> IntEvent1ImaskRxintW<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "CLR"]
    #[inline(always)]
    pub fn int_event1_imask_rxint_clr(self) -> &'a mut crate::W<REG> {
        self.variant(IntEvent1ImaskRxint::IntEvent1ImaskRxintClr)
    }
    #[doc = "SET"]
    #[inline(always)]
    pub fn int_event1_imask_rxint_set(self) -> &'a mut crate::W<REG> {
        self.variant(IntEvent1ImaskRxint::IntEvent1ImaskRxintSet)
    }
}
impl R {
    ...
    pub fn int_event1_imask_rtout(&self) -> IntEvent1ImaskRtoutR {
        IntEvent1ImaskRtoutR::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 10 - Enable UART Receive Interrupt."]
    #[inline(always)]
    pub fn int_event1_imask_rxint(&self) -> IntEvent1ImaskRxintR {
        IntEvent1ImaskRxintR::new(((self.bits >> 10) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - Enable UARTOUT Receive Time-Out Interrupt."]
    ...
    pub fn int_event1_imask_rtout(&mut self) -> IntEvent1ImaskRtoutW<IntEvent1ImaskSpec> {
        IntEvent1ImaskRtoutW::new(self, 0)
    }
    #[doc = "Bit 10 - Enable UART Receive Interrupt."]
    #[inline(always)]
    pub fn int_event1_imask_rxint(&mut self) -> IntEvent1ImaskRxintW<IntEvent1ImaskSpec> {
        IntEvent1ImaskRxintW::new(self, 10)
    }
}
