...
pub enum IntEvent1IidxStat {
    ...
    #[doc = "3: RTOUT_EVT"]
    IntEvent1IidxStatRtoutEvt = 3,
    #[doc = "4: RX_EVT"]
    IntEvent1IidxStatRxEvt = 4,
}
...
impl IntEvent1IidxStatR {
    ...
    pub const fn variant(&self) -> Option<IntEvent1IidxStat> {
        match self.bits {
            ...
            3 => Some(IntEvent1IidxStat::IntEvent1IidxStatRtoutEvt),
            4 => Some(IntEvent1IidxStat::IntEvent1IidxStatRxEvt),
            _ => None,
        }
    }
    #[doc = "NO_INTR"]
    ...
    #[doc = "RTOUT_EVT"]
    #[inline(always)]
    pub fn is_int_event1_iidx_stat_rtout_evt(&self) -> bool {
        *self == IntEvent1IidxStat::IntEvent1IidxStatRtoutEvt
    }
    #[doc = "RX_EVT"]
    #[inline(always)]
    pub fn is_int_event1_iidx_stat_rx_evt(&self) -> bool {
        *self == IntEvent1IidxStat::IntEvent1IidxStatRxEvt
    }
}
impl R {
