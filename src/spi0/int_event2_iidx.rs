...
impl IntEvent2IidxStatR {
    ...
    pub const fn variant(&self) -> Option<IntEvent2IidxStat> {
        match self.bits {
            ...
            5 => Some(IntEvent2IidxStat::IntEvent2IidxStatTxEvt),
            _ => None,
        }
    }
    #[doc = "NO_INTR"]
    ...
    #[doc = "TX_EVT"]
    #[inline(always)]
    pub fn is_int_event2_iidx_stat_tx_evt(&self) -> bool {
        *self == IntEvent2IidxStat::IntEvent2IidxStatTxEvt
    }
}
impl R {
