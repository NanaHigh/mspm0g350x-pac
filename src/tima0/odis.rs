...
pub enum OdisC0ccp2 {
    #[doc = "0: CCP_OUTPUT_OCTL"]
    OdisC0ccp2CcpOutputOctl = 0,
    #[doc = "1: CCP_OUTPUT_LOW"]
    OdisC0ccp2CcpOutputLow = 1,
}
impl From<OdisC0ccp2> for bool {
    #[inline(always)]
    fn from(variant: OdisC0ccp2) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `ODIS_C0CCP2` reader - Counter CCP2 Disable Mask Defines whether CCP2 of Counter n is forced low or not"]
pub type OdisC0ccp2R = crate::BitReader<OdisC0ccp2>;
impl OdisC0ccp2R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> OdisC0ccp2 {
        match self.bits {
            false => OdisC0ccp2::OdisC0ccp2CcpOutputOctl,
            true => OdisC0ccp2::OdisC0ccp2CcpOutputLow,
        }
    }
    #[doc = "CCP_OUTPUT_OCTL"]
    #[inline(always)]
    pub fn is_odis_c0ccp2_ccp_output_octl(&self) -> bool {
        *self == OdisC0ccp2::OdisC0ccp2CcpOutputOctl
    }
    #[doc = "CCP_OUTPUT_LOW"]
    #[inline(always)]
    pub fn is_odis_c0ccp2_ccp_output_low(&self) -> bool {
        *self == OdisC0ccp2::OdisC0ccp2CcpOutputLow
    }
}
#[doc = "Field `ODIS_C0CCP2` writer - Counter CCP2 Disable Mask Defines whether CCP2 of Counter n is forced low or not"]
pub type OdisC0ccp2W<'a, REG> = crate::BitWriter<'a, REG, OdisC0ccp2>;
impl<'a, REG> OdisC0ccp2W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "CCP_OUTPUT_OCTL"]
    #[inline(always)]
    pub fn odis_c0ccp2_ccp_output_octl(self) -> &'a mut crate::W<REG> {
        self.variant(OdisC0ccp2::OdisC0ccp2CcpOutputOctl)
    }
    #[doc = "CCP_OUTPUT_LOW"]
    #[inline(always)]
    pub fn odis_c0ccp2_ccp_output_low(self) -> &'a mut crate::W<REG> {
        self.variant(OdisC0ccp2::OdisC0ccp2CcpOutputLow)
    }
}
...
pub enum OdisC0ccp3 {
    #[doc = "0: CCP_OUTPUT_OCTL"]
    OdisC0ccp3CcpOutputOctl = 0,
    #[doc = "1: CCP_OUTPUT_LOW"]
    OdisC0ccp3CcpOutputLow = 1,
}
impl From<OdisC0ccp3> for bool {
    #[inline(always)]
    fn from(variant: OdisC0ccp3) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `ODIS_C0CCP3` reader - Counter CCP3 Disable Mask Defines whether CCP3 of Counter n is forced low or not"]
pub type OdisC0ccp3R = crate::BitReader<OdisC0ccp3>;
impl OdisC0ccp3R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> OdisC0ccp3 {
        match self.bits {
            false => OdisC0ccp3::OdisC0ccp3CcpOutputOctl,
            true => OdisC0ccp3::OdisC0ccp3CcpOutputLow,
        }
    }
    #[doc = "CCP_OUTPUT_OCTL"]
    #[inline(always)]
    pub fn is_odis_c0ccp3_ccp_output_octl(&self) -> bool {
        *self == OdisC0ccp3::OdisC0ccp3CcpOutputOctl
    }
    #[doc = "CCP_OUTPUT_LOW"]
    #[inline(always)]
    pub fn is_odis_c0ccp3_ccp_output_low(&self) -> bool {
        *self == OdisC0ccp3::OdisC0ccp3CcpOutputLow
    }
}
#[doc = "Field `ODIS_C0CCP3` writer - Counter CCP3 Disable Mask Defines whether CCP3 of Counter n is forced low or not"]
pub type OdisC0ccp3W<'a, REG> = crate::BitWriter<'a, REG, OdisC0ccp3>;
impl<'a, REG> OdisC0ccp3W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "CCP_OUTPUT_OCTL"]
    #[inline(always)]
    pub fn odis_c0ccp3_ccp_output_octl(self) -> &'a mut crate::W<REG> {
        self.variant(OdisC0ccp3::OdisC0ccp3CcpOutputOctl)
    }
    #[doc = "CCP_OUTPUT_LOW"]
    #[inline(always)]
    pub fn odis_c0ccp3_ccp_output_low(self) -> &'a mut crate::W<REG> {
        self.variant(OdisC0ccp3::OdisC0ccp3CcpOutputLow)
    }
}
impl R {
    ...
    #[inline(always)]
    pub fn odis_c0ccp2(&self) -> OdisC0ccp2R {
        OdisC0ccp2R::new(((self.bits >> 2) & 1) != 0)
    }
    #[doc = "Bit 3 - Counter CCP3 Disable Mask Defines whether CCP3 of Counter n is forced low or not"]
    #[inline(always)]
    pub fn odis_c0ccp3(&self) -> OdisC0ccp3R {
        OdisC0ccp3R::new(((self.bits >> 3) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - Counter CCP0 Disable Mask Defines whether CCP0 of Counter n is forced low or not"]
    ...
    #[doc = "Bit 2 - Counter CCP2 Disable Mask Defines whether CCP2 of Counter n is forced low or not"]
    #[inline(always)]
    pub fn odis_c0ccp2(&mut self) -> OdisC0ccp2W<OdisSpec> {
        OdisC0ccp2W::new(self, 2)
    }
    #[doc = "Bit 3 - Counter CCP3 Disable Mask Defines whether CCP3 of Counter n is forced low or not"]
    #[inline(always)]
    pub fn odis_c0ccp3(&mut self) -> OdisC0ccp3W<OdisSpec> {
        OdisC0ccp3W::new(self, 3)
    }
}
