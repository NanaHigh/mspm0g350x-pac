...
impl From<IsetCcd2> for bool {
    #[inline(always)]
    fn from(variant: IsetCcd2) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `ISET_CCD2` writer - Capture or compare down event SET"]
pub type IsetCcd2W<'a, REG> = crate::BitWriter<'a, REG, IsetCcd2>;
impl<'a, REG> IsetCcd2W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "NO_EFFECT"]
    #[inline(always)]
    pub fn iset_ccd2_no_effect(self) -> &'a mut crate::W<REG> {
        self.variant(IsetCcd2::IsetCcd2NoEffect)
    }
    #[doc = "SET"]
    #[inline(always)]
    pub fn iset_ccd2_set(self) -> &'a mut crate::W<REG> {
        self.variant(IsetCcd2::IsetCcd2Set)
    }
}
#[doc = "Capture or compare down event SET\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
...
impl From<IsetCcd3> for bool {
    #[inline(always)]
    fn from(variant: IsetCcd3) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `ISET_CCD3` writer - Capture or compare down event SET"]
pub type IsetCcd3W<'a, REG> = crate::BitWriter<'a, REG, IsetCcd3>;
impl<'a, REG> IsetCcd3W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "NO_EFFECT"]
    #[inline(always)]
    pub fn iset_ccd3_no_effect(self) -> &'a mut crate::W<REG> {
        self.variant(IsetCcd3::IsetCcd3NoEffect)
    }
    #[doc = "SET"]
    #[inline(always)]
    pub fn iset_ccd3_set(self) -> &'a mut crate::W<REG> {
        self.variant(IsetCcd3::IsetCcd3Set)
    }
}
...
impl From<IsetCcu2> for bool {
    #[inline(always)]
    fn from(variant: IsetCcu2) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `ISET_CCU2` writer - Capture or compare up event SET"]
pub type IsetCcu2W<'a, REG> = crate::BitWriter<'a, REG, IsetCcu2>;
impl<'a, REG> IsetCcu2W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "NO_EFFECT"]
    #[inline(always)]
    pub fn iset_ccu2_no_effect(self) -> &'a mut crate::W<REG> {
        self.variant(IsetCcu2::IsetCcu2NoEffect)
    }
    #[doc = "SET"]
    #[inline(always)]
    pub fn iset_ccu2_set(self) -> &'a mut crate::W<REG> {
        self.variant(IsetCcu2::IsetCcu2Set)
    }
}
#[doc = "Capture or compare up event SET\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
...
impl From<IsetCcu3> for bool {
    #[inline(always)]
    fn from(variant: IsetCcu3) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `ISET_CCU3` writer - Capture or compare up event SET"]
pub type IsetCcu3W<'a, REG> = crate::BitWriter<'a, REG, IsetCcu3>;
impl<'a, REG> IsetCcu3W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "NO_EFFECT"]
    #[inline(always)]
    pub fn iset_ccu3_no_effect(self) -> &'a mut crate::W<REG> {
        self.variant(IsetCcu3::IsetCcu3NoEffect)
    }
    #[doc = "SET"]
    #[inline(always)]
    pub fn iset_ccu3_set(self) -> &'a mut crate::W<REG> {
        self.variant(IsetCcu3::IsetCcu3Set)
    }
}
...
impl From<IsetRepc> for bool {
    #[inline(always)]
    fn from(variant: IsetRepc) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `ISET_REPC` writer - Repeat Counter Zero event SET"]
pub type IsetRepcW<'a, REG> = crate::BitWriter<'a, REG, IsetRepc>;
impl<'a, REG> IsetRepcW<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "NO_EFFECT"]
    #[inline(always)]
    pub fn iset_repc_no_effect(self) -> &'a mut crate::W<REG> {
        self.variant(IsetRepc::IsetRepcNoEffect)
    }
    #[doc = "SET"]
    #[inline(always)]
    pub fn iset_repc_set(self) -> &'a mut crate::W<REG> {
        self.variant(IsetRepc::IsetRepcSet)
    }
}
impl W {
    ...
    #[inline(always)]
    pub fn iset_ccd2(&mut self) -> IsetCcd2W<IsetSpec> {
        IsetCcd2W::new(self, 6)
    }
    #[doc = "Bit 7 - Capture or compare down event SET"]
    #[inline(always)]
    pub fn iset_ccd3(&mut self) -> IsetCcd3W<IsetSpec> {
        IsetCcd3W::new(self, 7)
    }
    ...
    #[inline(always)]
    pub fn iset_ccu2(&mut self) -> IsetCcu2W<IsetSpec> {
        IsetCcu2W::new(self, 10)
    }
    #[doc = "Bit 11 - Capture or compare up event SET"]
    #[inline(always)]
    pub fn iset_ccu3(&mut self) -> IsetCcu3W<IsetSpec> {
        IsetCcu3W::new(self, 11)
    }
    ...
    #[inline(always)]
    pub fn iset_repc(&mut self) -> IsetRepcW<IsetSpec> {
        IsetRepcW::new(self, 26)
    }
}
