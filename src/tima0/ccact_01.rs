...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
#[repr(u8)]
pub enum Ccact01Fenact {
    #[doc = "0: DISABLED"]
    Ccact01FenactDisabled = 0,
    #[doc = "1: CCP_HIGH"]
    Ccact01FenactCcpHigh = 1,
    #[doc = "2: CCP_LOW"]
    Ccact01FenactCcpLow = 2,
    #[doc = "3: CCP_TOGGLE"]
    Ccact01FenactCcpToggle = 3,
    #[doc = "4: CCP_HIGHZ"]
    Ccact01FenactCcpHighz = 4,
}
impl From<Ccact01Fenact> for u8 {
    #[inline(always)]
    fn from(variant: Ccact01Fenact) -> Self {
        variant as _
    }
}
impl crate::FieldSpec for Ccact01Fenact {
    type Ux = u8;
}
impl crate::IsEnum for Ccact01Fenact {}
#[doc = "Field `CCACT_01_FENACT` reader - CCP Output Action on Fault Entry This field describes the resulting action of the signal generator upon detecting a fault."]
pub type Ccact01FenactR = crate::FieldReader<Ccact01Fenact>;
impl Ccact01FenactR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Option<Ccact01Fenact> {
        match self.bits {
            0 => Some(Ccact01Fenact::Ccact01FenactDisabled),
            1 => Some(Ccact01Fenact::Ccact01FenactCcpHigh),
            2 => Some(Ccact01Fenact::Ccact01FenactCcpLow),
            3 => Some(Ccact01Fenact::Ccact01FenactCcpToggle),
            4 => Some(Ccact01Fenact::Ccact01FenactCcpHighz),
            _ => None,
        }
    }
    #[doc = "DISABLED"]
    #[inline(always)]
    pub fn is_ccact_01_fenact_disabled(&self) -> bool {
        *self == Ccact01Fenact::Ccact01FenactDisabled
    }
    #[doc = "CCP_HIGH"]
    #[inline(always)]
    pub fn is_ccact_01_fenact_ccp_high(&self) -> bool {
        *self == Ccact01Fenact::Ccact01FenactCcpHigh
    }
    #[doc = "CCP_LOW"]
    #[inline(always)]
    pub fn is_ccact_01_fenact_ccp_low(&self) -> bool {
        *self == Ccact01Fenact::Ccact01FenactCcpLow
    }
    #[doc = "CCP_TOGGLE"]
    #[inline(always)]
    pub fn is_ccact_01_fenact_ccp_toggle(&self) -> bool {
        *self == Ccact01Fenact::Ccact01FenactCcpToggle
    }
    #[doc = "CCP_HIGHZ"]
    #[inline(always)]
    pub fn is_ccact_01_fenact_ccp_highz(&self) -> bool {
        *self == Ccact01Fenact::Ccact01FenactCcpHighz
    }
}
#[doc = "Field `CCACT_01_FENACT` writer - CCP Output Action on Fault Entry This field describes the resulting action of the signal generator upon detecting a fault."]
pub type Ccact01FenactW<'a, REG> = crate::FieldWriter<'a, REG, 3, Ccact01Fenact>;
impl<'a, REG> Ccact01FenactW<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
    REG::Ux: From<u8>,
{
    #[doc = "DISABLED"]
    #[inline(always)]
    pub fn ccact_01_fenact_disabled(self) -> &'a mut crate::W<REG> {
        self.variant(Ccact01Fenact::Ccact01FenactDisabled)
    }
    #[doc = "CCP_HIGH"]
    #[inline(always)]
    pub fn ccact_01_fenact_ccp_high(self) -> &'a mut crate::W<REG> {
        self.variant(Ccact01Fenact::Ccact01FenactCcpHigh)
    }
    #[doc = "CCP_LOW"]
    #[inline(always)]
    pub fn ccact_01_fenact_ccp_low(self) -> &'a mut crate::W<REG> {
        self.variant(Ccact01Fenact::Ccact01FenactCcpLow)
    }
    #[doc = "CCP_TOGGLE"]
    #[inline(always)]
    pub fn ccact_01_fenact_ccp_toggle(self) -> &'a mut crate::W<REG> {
        self.variant(Ccact01Fenact::Ccact01FenactCcpToggle)
    }
    #[doc = "CCP_HIGHZ"]
    #[inline(always)]
    pub fn ccact_01_fenact_ccp_highz(self) -> &'a mut crate::W<REG> {
        self.variant(Ccact01Fenact::Ccact01FenactCcpHighz)
    }
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
#[repr(u8)]
pub enum Ccact01Fexact {
    #[doc = "0: DISABLED"]
    Ccact01FexactDisabled = 0,
    #[doc = "1: CCP_HIGH"]
    Ccact01FexactCcpHigh = 1,
    #[doc = "2: CCP_LOW"]
    Ccact01FexactCcpLow = 2,
    #[doc = "3: CCP_TOGGLE"]
    Ccact01FexactCcpToggle = 3,
    #[doc = "4: CCP_HIGHZ"]
    Ccact01FexactCcpHighz = 4,
}
impl From<Ccact01Fexact> for u8 {
    #[inline(always)]
    fn from(variant: Ccact01Fexact) -> Self {
        variant as _
    }
}
impl crate::FieldSpec for Ccact01Fexact {
    type Ux = u8;
}
impl crate::IsEnum for Ccact01Fexact {}
#[doc = "Field `CCACT_01_FEXACT` reader - CCP Output Action on Fault Exit This field describes the resulting action of the signal generator upon exiting the fault condition."]
pub type Ccact01FexactR = crate::FieldReader<Ccact01Fexact>;
impl Ccact01FexactR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Option<Ccact01Fexact> {
        match self.bits {
            0 => Some(Ccact01Fexact::Ccact01FexactDisabled),
            1 => Some(Ccact01Fexact::Ccact01FexactCcpHigh),
            2 => Some(Ccact01Fexact::Ccact01FexactCcpLow),
            3 => Some(Ccact01Fexact::Ccact01FexactCcpToggle),
            4 => Some(Ccact01Fexact::Ccact01FexactCcpHighz),
            _ => None,
        }
    }
    #[doc = "DISABLED"]
    #[inline(always)]
    pub fn is_ccact_01_fexact_disabled(&self) -> bool {
        *self == Ccact01Fexact::Ccact01FexactDisabled
    }
    #[doc = "CCP_HIGH"]
    #[inline(always)]
    pub fn is_ccact_01_fexact_ccp_high(&self) -> bool {
        *self == Ccact01Fexact::Ccact01FexactCcpHigh
    }
    #[doc = "CCP_LOW"]
    #[inline(always)]
    pub fn is_ccact_01_fexact_ccp_low(&self) -> bool {
        *self == Ccact01Fexact::Ccact01FexactCcpLow
    }
    #[doc = "CCP_TOGGLE"]
    #[inline(always)]
    pub fn is_ccact_01_fexact_ccp_toggle(&self) -> bool {
        *self == Ccact01Fexact::Ccact01FexactCcpToggle
    }
    #[doc = "CCP_HIGHZ"]
    #[inline(always)]
    pub fn is_ccact_01_fexact_ccp_highz(&self) -> bool {
        *self == Ccact01Fexact::Ccact01FexactCcpHighz
    }
}
#[doc = "Field `CCACT_01_FEXACT` writer - CCP Output Action on Fault Exit This field describes the resulting action of the signal generator upon exiting the fault condition."]
pub type Ccact01FexactW<'a, REG> = crate::FieldWriter<'a, REG, 3, Ccact01Fexact>;
impl<'a, REG> Ccact01FexactW<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
    REG::Ux: From<u8>,
{
    #[doc = "DISABLED"]
    #[inline(always)]
    pub fn ccact_01_fexact_disabled(self) -> &'a mut crate::W<REG> {
        self.variant(Ccact01Fexact::Ccact01FexactDisabled)
    }
    #[doc = "CCP_HIGH"]
    #[inline(always)]
    pub fn ccact_01_fexact_ccp_high(self) -> &'a mut crate::W<REG> {
        self.variant(Ccact01Fexact::Ccact01FexactCcpHigh)
    }
    #[doc = "CCP_LOW"]
    #[inline(always)]
    pub fn ccact_01_fexact_ccp_low(self) -> &'a mut crate::W<REG> {
        self.variant(Ccact01Fexact::Ccact01FexactCcpLow)
    }
    #[doc = "CCP_TOGGLE"]
    #[inline(always)]
    pub fn ccact_01_fexact_ccp_toggle(self) -> &'a mut crate::W<REG> {
        self.variant(Ccact01Fexact::Ccact01FexactCcpToggle)
    }
    #[doc = "CCP_HIGHZ"]
    #[inline(always)]
    pub fn ccact_01_fexact_ccp_highz(self) -> &'a mut crate::W<REG> {
        self.variant(Ccact01Fexact::Ccact01FexactCcpHighz)
    }
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
#[repr(u8)]
pub enum Ccact01SwfrcactCmpl {
    #[doc = "0: DISABLED"]
    Ccact01SwfrcactCmplDisabled = 0,
    #[doc = "1: CCP_HIGH"]
    Ccact01SwfrcactCmplCcpHigh = 1,
    #[doc = "2: CCP_LOW"]
    Ccact01SwfrcactCmplCcpLow = 2,
}
impl From<Ccact01SwfrcactCmpl> for u8 {
    #[inline(always)]
    fn from(variant: Ccact01SwfrcactCmpl) -> Self {
        variant as _
    }
}
impl crate::FieldSpec for Ccact01SwfrcactCmpl {
    type Ux = u8;
}
impl crate::IsEnum for Ccact01SwfrcactCmpl {}
#[doc = "Field `CCACT_01_SWFRCACT_CMPL` reader - CCP_CMPL Output Action on Software Froce Output This field describes the resulting action of software force. This action has a shadow register, which will be updated under specific condition. So that this register cannot take into effect immediately."]
pub type Ccact01SwfrcactCmplR = crate::FieldReader<Ccact01SwfrcactCmpl>;
impl Ccact01SwfrcactCmplR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Option<Ccact01SwfrcactCmpl> {
        match self.bits {
            0 => Some(Ccact01SwfrcactCmpl::Ccact01SwfrcactCmplDisabled),
            1 => Some(Ccact01SwfrcactCmpl::Ccact01SwfrcactCmplCcpHigh),
            2 => Some(Ccact01SwfrcactCmpl::Ccact01SwfrcactCmplCcpLow),
            _ => None,
        }
    }
    #[doc = "DISABLED"]
    #[inline(always)]
    pub fn is_ccact_01_swfrcact_cmpl_disabled(&self) -> bool {
        *self == Ccact01SwfrcactCmpl::Ccact01SwfrcactCmplDisabled
    }
    #[doc = "CCP_HIGH"]
    #[inline(always)]
    pub fn is_ccact_01_swfrcact_cmpl_ccp_high(&self) -> bool {
        *self == Ccact01SwfrcactCmpl::Ccact01SwfrcactCmplCcpHigh
    }
    #[doc = "CCP_LOW"]
    #[inline(always)]
    pub fn is_ccact_01_swfrcact_cmpl_ccp_low(&self) -> bool {
        *self == Ccact01SwfrcactCmpl::Ccact01SwfrcactCmplCcpLow
    }
}
#[doc = "Field `CCACT_01_SWFRCACT_CMPL` writer - CCP_CMPL Output Action on Software Froce Output This field describes the resulting action of software force. This action has a shadow register, which will be updated under specific condition. So that this register cannot take into effect immediately."]
pub type Ccact01SwfrcactCmplW<'a, REG> = crate::FieldWriter<'a, REG, 2, Ccact01SwfrcactCmpl>;
impl<'a, REG> Ccact01SwfrcactCmplW<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
    REG::Ux: From<u8>,
{
    #[doc = "DISABLED"]
    #[inline(always)]
    pub fn ccact_01_swfrcact_cmpl_disabled(self) -> &'a mut crate::W<REG> {
        self.variant(Ccact01SwfrcactCmpl::Ccact01SwfrcactCmplDisabled)
    }
    #[doc = "CCP_HIGH"]
    #[inline(always)]
    pub fn ccact_01_swfrcact_cmpl_ccp_high(self) -> &'a mut crate::W<REG> {
        self.variant(Ccact01SwfrcactCmpl::Ccact01SwfrcactCmplCcpHigh)
    }
    #[doc = "CCP_LOW"]
    #[inline(always)]
    pub fn ccact_01_swfrcact_cmpl_ccp_low(self) -> &'a mut crate::W<REG> {
        self.variant(Ccact01SwfrcactCmpl::Ccact01SwfrcactCmplCcpLow)
    }
}
impl R {
    ...
    #[inline(always)]
    pub fn ccact_01_fenact(&self) -> Ccact01FenactR {
        Ccact01FenactR::new(((self.bits >> 22) & 7) as u8)
    }
    ...
    #[inline(always)]
    pub fn ccact_01_fexact(&self) -> Ccact01FexactR {
        Ccact01FexactR::new(((self.bits >> 25) & 7) as u8)
    }
    ...
    #[inline(always)]
    pub fn ccact_01_swfrcact_cmpl(&self) -> Ccact01SwfrcactCmplR {
        Ccact01SwfrcactCmplR::new(((self.bits >> 30) & 3) as u8)
    }
}
impl W {
    #[doc = "Bits 0:1 - CCP Output Action on Zero Specifies what changes occur to CCP output as the result of a zero event."]
    ...
    #[doc = "Bits 22:24 - CCP Output Action on Fault Entry This field describes the resulting action of the signal generator upon detecting a fault."]
    #[inline(always)]
    pub fn ccact_01_fenact(&mut self) -> Ccact01FenactW<Ccact01Spec> {
        Ccact01FenactW::new(self, 22)
    }
    #[doc = "Bits 25:27 - CCP Output Action on Fault Exit This field describes the resulting action of the signal generator upon exiting the fault condition."]
    #[inline(always)]
    pub fn ccact_01_fexact(&mut self) -> Ccact01FexactW<Ccact01Spec> {
        Ccact01FexactW::new(self, 25)
    }
    #[doc = "Bits 28:29 - CCP Output Action on Software Froce Output This field describes the resulting action of software force. This action has a shadow register, which will be updated under specific condition. So that this register cannot take into effect immediately."]
    #[inline(always)]
    ...
    #[doc = "Bits 30:31 - CCP_CMPL Output Action on Software Froce Output This field describes the resulting action of software force. This action has a shadow register, which will be updated under specific condition. So that this register cannot take into effect immediately."]
    #[inline(always)]
    pub fn ccact_01_swfrcact_cmpl(&mut self) -> Ccact01SwfrcactCmplW<Ccact01Spec> {
        Ccact01SwfrcactCmplW::new(self, 30)
    }
}
