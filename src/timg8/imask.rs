...
impl From<ImaskDc> for bool {
    #[inline(always)]
    fn from(variant: ImaskDc) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `IMASK_DC` reader - Direction Change Event mask"]
pub type ImaskDcR = crate::BitReader<ImaskDc>;
impl ImaskDcR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> ImaskDc {
        match self.bits {
            false => ImaskDc::ImaskDcClr,
            true => ImaskDc::ImaskDcSet,
        }
    }
    #[doc = "CLR"]
    #[inline(always)]
    pub fn is_imask_dc_clr(&self) -> bool {
        *self == ImaskDc::ImaskDcClr
    }
    #[doc = "SET"]
    #[inline(always)]
    pub fn is_imask_dc_set(&self) -> bool {
        *self == ImaskDc::ImaskDcSet
    }
}
#[doc = "Field `IMASK_DC` writer - Direction Change Event mask"]
pub type ImaskDcW<'a, REG> = crate::BitWriter<'a, REG, ImaskDc>;
impl<'a, REG> ImaskDcW<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "CLR"]
    #[inline(always)]
    pub fn imask_dc_clr(self) -> &'a mut crate::W<REG> {
        self.variant(ImaskDc::ImaskDcClr)
    }
    #[doc = "SET"]
    #[inline(always)]
    pub fn imask_dc_set(self) -> &'a mut crate::W<REG> {
        self.variant(ImaskDc::ImaskDcSet)
    }
}
#[doc = "QEIERR Event mask\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum ImaskQeierr {
    #[doc = "0: CLR"]
    ImaskQeierrClr = 0,
    #[doc = "1: SET"]
    ImaskQeierrSet = 1,
}
impl From<ImaskQeierr> for bool {
    #[inline(always)]
    fn from(variant: ImaskQeierr) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `IMASK_QEIERR` reader - QEIERR Event mask"]
pub type ImaskQeierrR = crate::BitReader<ImaskQeierr>;
impl ImaskQeierrR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> ImaskQeierr {
        match self.bits {
            false => ImaskQeierr::ImaskQeierrClr,
            true => ImaskQeierr::ImaskQeierrSet,
        }
    }
    #[doc = "CLR"]
    #[inline(always)]
    pub fn is_imask_qeierr_clr(&self) -> bool {
        *self == ImaskQeierr::ImaskQeierrClr
    }
    #[doc = "SET"]
    #[inline(always)]
    pub fn is_imask_qeierr_set(&self) -> bool {
        *self == ImaskQeierr::ImaskQeierrSet
    }
}
#[doc = "Field `IMASK_QEIERR` writer - QEIERR Event mask"]
pub type ImaskQeierrW<'a, REG> = crate::BitWriter<'a, REG, ImaskQeierr>;
impl<'a, REG> ImaskQeierrW<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "CLR"]
    #[inline(always)]
    pub fn imask_qeierr_clr(self) -> &'a mut crate::W<REG> {
        self.variant(ImaskQeierr::ImaskQeierrClr)
    }
    #[doc = "SET"]
    #[inline(always)]
    pub fn imask_qeierr_set(self) -> &'a mut crate::W<REG> {
        self.variant(ImaskQeierr::ImaskQeierrSet)
    }
}
impl R {
    ...
    #[inline(always)]
    pub fn imask_dc(&self) -> ImaskDcR {
        ImaskDcR::new(((self.bits >> 27) & 1) != 0)
    }
    #[doc = "Bit 28 - QEIERR Event mask"]
    #[inline(always)]
    pub fn imask_qeierr(&self) -> ImaskQeierrR {
        ImaskQeierrR::new(((self.bits >> 28) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - Zero Event mask"]
    ...
    #[doc = "Bit 27 - Direction Change Event mask"]
    #[inline(always)]
    pub fn imask_dc(&mut self) -> ImaskDcW<ImaskSpec> {
        ImaskDcW::new(self, 27)
    }
    #[doc = "Bit 28 - QEIERR Event mask"]
    #[inline(always)]
    pub fn imask_qeierr(&mut self) -> ImaskQeierrW<ImaskSpec> {
        ImaskQeierrW::new(self, 28)
    }
}
