...
impl From<IclrDc> for bool {
    #[inline(always)]
    fn from(variant: IclrDc) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `ICLR_DC` writer - Direction Change event CLEAR"]
pub type IclrDcW<'a, REG> = crate::BitWriter<'a, REG, IclrDc>;
impl<'a, REG> IclrDcW<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "NO_EFFECT"]
    #[inline(always)]
    pub fn iclr_dc_no_effect(self) -> &'a mut crate::W<REG> {
        self.variant(IclrDc::IclrDcNoEffect)
    }
    #[doc = "CLR"]
    #[inline(always)]
    pub fn iclr_dc_clr(self) -> &'a mut crate::W<REG> {
        self.variant(IclrDc::IclrDcClr)
    }
}
...
pub enum IclrQeierr {
    #[doc = "0: NO_EFFECT"]
    IclrQeierrNoEffect = 0,
    #[doc = "1: CLR"]
    IclrQeierrClr = 1,
}
impl From<IclrQeierr> for bool {
    #[inline(always)]
    fn from(variant: IclrQeierr) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `ICLR_QEIERR` writer - QEIERR event CLEAR"]
pub type IclrQeierrW<'a, REG> = crate::BitWriter<'a, REG, IclrQeierr>;
impl<'a, REG> IclrQeierrW<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "NO_EFFECT"]
    #[inline(always)]
    pub fn iclr_qeierr_no_effect(self) -> &'a mut crate::W<REG> {
        self.variant(IclrQeierr::IclrQeierrNoEffect)
    }
    #[doc = "CLR"]
    #[inline(always)]
    pub fn iclr_qeierr_clr(self) -> &'a mut crate::W<REG> {
        self.variant(IclrQeierr::IclrQeierrClr)
    }
}
impl W {
    ...
    #[inline(always)]
    pub fn iclr_dc(&mut self) -> IclrDcW<IclrSpec> {
        IclrDcW::new(self, 27)
    }
    #[doc = "Bit 28 - QEIERR event CLEAR"]
    #[inline(always)]
    pub fn iclr_qeierr(&mut self) -> IclrQeierrW<IclrSpec> {
        IclrQeierrW::new(self, 28)
    }
}
