...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum ClkselSysclkSel {
    #[doc = "0: DISABLE"]
    ClkselSysclkSelDisable = 0,
    #[doc = "1: ENABLE"]
    ClkselSysclkSelEnable = 1,
}
impl From<ClkselSysclkSel> for bool {
    #[inline(always)]
    fn from(variant: ClkselSysclkSel) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `CLKSEL_SYSCLK_SEL` reader - Selects SYSCLK as clock source if enabled"]
pub type ClkselSysclkSelR = crate::BitReader<ClkselSysclkSel>;
impl ClkselSysclkSelR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> ClkselSysclkSel {
        match self.bits {
            false => ClkselSysclkSel::ClkselSysclkSelDisable,
            true => ClkselSysclkSel::ClkselSysclkSelEnable,
        }
    }
    #[doc = "DISABLE"]
    #[inline(always)]
    pub fn is_clksel_sysclk_sel_disable(&self) -> bool {
        *self == ClkselSysclkSel::ClkselSysclkSelDisable
    }
    #[doc = "ENABLE"]
    #[inline(always)]
    pub fn is_clksel_sysclk_sel_enable(&self) -> bool {
        *self == ClkselSysclkSel::ClkselSysclkSelEnable
    }
}
#[doc = "Field `CLKSEL_SYSCLK_SEL` writer - Selects SYSCLK as clock source if enabled"]
pub type ClkselSysclkSelW<'a, REG> = crate::BitWriter<'a, REG, ClkselSysclkSel>;
impl<'a, REG> ClkselSysclkSelW<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "DISABLE"]
    #[inline(always)]
    pub fn clksel_sysclk_sel_disable(self) -> &'a mut crate::W<REG> {
        self.variant(ClkselSysclkSel::ClkselSysclkSelDisable)
    }
    #[doc = "ENABLE"]
    #[inline(always)]
    pub fn clksel_sysclk_sel_enable(self) -> &'a mut crate::W<REG> {
        self.variant(ClkselSysclkSel::ClkselSysclkSelEnable)
    }
}
impl R {
    ...
    #[inline(always)]
    pub fn clksel_sysclk_sel(&self) -> ClkselSysclkSelR {
        ClkselSysclkSelR::new(((self.bits >> 3) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 1 - Selects LFCLK as clock source if enabled"]
    ...
    #[doc = "Bit 3 - Selects SYSCLK as clock source if enabled"]
    #[inline(always)]
    pub fn clksel_sysclk_sel(&mut self) -> ClkselSysclkSelW<ClkselSpec> {
        ClkselSysclkSelW::new(self, 3)
    }
}
