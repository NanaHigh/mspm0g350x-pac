...
#[doc = "Field `INT_EVENT1_ISET_RTOUT` writer - Set SPI Receive Time-Out event."]
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum IntEvent1IsetRx {
    #[doc = "0: NO_EFFECT"]
    IntEvent1IsetRxNoEffect = 0,
    #[doc = "1: SET"]
    IntEvent1IsetRxSet = 1,
}
impl From<IntEvent1IsetRx> for bool {
    #[inline(always)]
    fn from(variant: IntEvent1IsetRx) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `INT_EVENT1_ISET_RX` writer - Set Receive FIFO event."]
pub type IntEvent1IsetRxW<'a, REG> = crate::BitWriter<'a, REG, IntEvent1IsetRx>;
impl<'a, REG> IntEvent1IsetRxW<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "NO_EFFECT"]
    #[inline(always)]
    pub fn int_event1_iset_rx_no_effect(self) -> &'a mut crate::W<REG> {
        self.variant(IntEvent1IsetRx::IntEvent1IsetRxNoEffect)
    }
    #[doc = "SET"]
    #[inline(always)]
    pub fn int_event1_iset_rx_set(self) -> &'a mut crate::W<REG> {
        self.variant(IntEvent1IsetRx::IntEvent1IsetRxSet)
    }
}
impl W {
    ...
    pub fn int_event1_iset_rtout(&mut self) -> IntEvent1IsetRtoutW<IntEvent1IsetSpec> {
        IntEvent1IsetRtoutW::new(self, 2)
    }
    #[doc = "Bit 3 - Set Receive FIFO event."]
    #[inline(always)]
    pub fn int_event1_iset_rx(&mut self) -> IntEvent1IsetRxW<IntEvent1IsetSpec> {
        IntEvent1IsetRxW::new(self, 3)
    }
}
