...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum IntEvent0IsetLinc0 {
    #[doc = "0: NO_EFFECT"]
    IntEvent0IsetLinc0NoEffect = 0,
    #[doc = "1: SET"]
    IntEvent0IsetLinc0Set = 1,
}
impl From<IntEvent0IsetLinc0> for bool {
    #[inline(always)]
    fn from(variant: IntEvent0IsetLinc0) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `INT_EVENT0_ISET_LINC0` writer - Set LIN Capture 0 / Match Interrupt ."]
pub type IntEvent0IsetLinc0W<'a, REG> = crate::BitWriter<'a, REG, IntEvent0IsetLinc0>;
impl<'a, REG> IntEvent0IsetLinc0W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "NO_EFFECT"]
    #[inline(always)]
    pub fn int_event0_iset_linc0_no_effect(self) -> &'a mut crate::W<REG> {
        self.variant(IntEvent0IsetLinc0::IntEvent0IsetLinc0NoEffect)
    }
    #[doc = "SET"]
    #[inline(always)]
    pub fn int_event0_iset_linc0_set(self) -> &'a mut crate::W<REG> {
        self.variant(IntEvent0IsetLinc0::IntEvent0IsetLinc0Set)
    }
}
#[doc = "Set LIN Capture 1 Interrupt.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum IntEvent0IsetLinc1 {
    #[doc = "0: NO_EFFECT"]
    IntEvent0IsetLinc1NoEffect = 0,
    #[doc = "1: SET"]
    IntEvent0IsetLinc1Set = 1,
}
impl From<IntEvent0IsetLinc1> for bool {
    #[inline(always)]
    fn from(variant: IntEvent0IsetLinc1) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `INT_EVENT0_ISET_LINC1` writer - Set LIN Capture 1 Interrupt."]
pub type IntEvent0IsetLinc1W<'a, REG> = crate::BitWriter<'a, REG, IntEvent0IsetLinc1>;
impl<'a, REG> IntEvent0IsetLinc1W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "NO_EFFECT"]
    #[inline(always)]
    pub fn int_event0_iset_linc1_no_effect(self) -> &'a mut crate::W<REG> {
        self.variant(IntEvent0IsetLinc1::IntEvent0IsetLinc1NoEffect)
    }
    #[doc = "SET"]
    #[inline(always)]
    pub fn int_event0_iset_linc1_set(self) -> &'a mut crate::W<REG> {
        self.variant(IntEvent0IsetLinc1::IntEvent0IsetLinc1Set)
    }
}
#[doc = "Set LIN Hardware Counter Overflow Interrupt.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum IntEvent0IsetLinovf {
    #[doc = "0: NO_EFFECT"]
    IntEvent0IsetLinovfNoEffect = 0,
    #[doc = "1: SET"]
    IntEvent0IsetLinovfSet = 1,
}
impl From<IntEvent0IsetLinovf> for bool {
    #[inline(always)]
    fn from(variant: IntEvent0IsetLinovf) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `INT_EVENT0_ISET_LINOVF` writer - Set LIN Hardware Counter Overflow Interrupt."]
pub type IntEvent0IsetLinovfW<'a, REG> = crate::BitWriter<'a, REG, IntEvent0IsetLinovf>;
impl<'a, REG> IntEvent0IsetLinovfW<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "NO_EFFECT"]
    #[inline(always)]
    pub fn int_event0_iset_linovf_no_effect(self) -> &'a mut crate::W<REG> {
        self.variant(IntEvent0IsetLinovf::IntEvent0IsetLinovfNoEffect)
    }
    #[doc = "SET"]
    #[inline(always)]
    pub fn int_event0_iset_linovf_set(self) -> &'a mut crate::W<REG> {
        self.variant(IntEvent0IsetLinovf::IntEvent0IsetLinovfSet)
    }
}
...
impl W {
    ...
    #[inline(always)]
    pub fn int_event0_iset_linc0(&mut self) -> IntEvent0IsetLinc0W<IntEvent0IsetSpec> {
        IntEvent0IsetLinc0W::new(self, 7)
    }
    #[doc = "Bit 8 - Set LIN Capture 1 Interrupt."]
    #[inline(always)]
    pub fn int_event0_iset_linc1(&mut self) -> IntEvent0IsetLinc1W<IntEvent0IsetSpec> {
        IntEvent0IsetLinc1W::new(self, 8)
    }
    #[doc = "Bit 9 - Set LIN Hardware Counter Overflow Interrupt."]
    #[inline(always)]
    pub fn int_event0_iset_linovf(&mut self) -> IntEvent0IsetLinovfW<IntEvent0IsetSpec> {
        IntEvent0IsetLinovfW::new(self, 9)
    }
