...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum IntEvent0ImaskLinc0 {
    #[doc = "0: CLR"]
    IntEvent0ImaskLinc0Clr = 0,
    #[doc = "1: SET"]
    IntEvent0ImaskLinc0Set = 1,
}
impl From<IntEvent0ImaskLinc0> for bool {
    #[inline(always)]
    fn from(variant: IntEvent0ImaskLinc0) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `INT_EVENT0_IMASK_LINC0` reader - Enable LIN Capture 0 / Match Interrupt ."]
pub type IntEvent0ImaskLinc0R = crate::BitReader<IntEvent0ImaskLinc0>;
impl IntEvent0ImaskLinc0R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> IntEvent0ImaskLinc0 {
        match self.bits {
            false => IntEvent0ImaskLinc0::IntEvent0ImaskLinc0Clr,
            true => IntEvent0ImaskLinc0::IntEvent0ImaskLinc0Set,
        }
    }
    #[doc = "CLR"]
    #[inline(always)]
    pub fn is_int_event0_imask_linc0_clr(&self) -> bool {
        *self == IntEvent0ImaskLinc0::IntEvent0ImaskLinc0Clr
    }
    #[doc = "SET"]
    #[inline(always)]
    pub fn is_int_event0_imask_linc0_set(&self) -> bool {
        *self == IntEvent0ImaskLinc0::IntEvent0ImaskLinc0Set
    }
}
#[doc = "Field `INT_EVENT0_IMASK_LINC0` writer - Enable LIN Capture 0 / Match Interrupt ."]
pub type IntEvent0ImaskLinc0W<'a, REG> = crate::BitWriter<'a, REG, IntEvent0ImaskLinc0>;
impl<'a, REG> IntEvent0ImaskLinc0W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "CLR"]
    #[inline(always)]
    pub fn int_event0_imask_linc0_clr(self) -> &'a mut crate::W<REG> {
        self.variant(IntEvent0ImaskLinc0::IntEvent0ImaskLinc0Clr)
    }
    #[doc = "SET"]
    #[inline(always)]
    pub fn int_event0_imask_linc0_set(self) -> &'a mut crate::W<REG> {
        self.variant(IntEvent0ImaskLinc0::IntEvent0ImaskLinc0Set)
    }
}
#[doc = "Enable LIN Capture 1 Interrupt.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum IntEvent0ImaskLinc1 {
    #[doc = "0: CLR"]
    IntEvent0ImaskLinc1Clr = 0,
    #[doc = "1: SET"]
    IntEvent0ImaskLinc1Set = 1,
}
impl From<IntEvent0ImaskLinc1> for bool {
    #[inline(always)]
    fn from(variant: IntEvent0ImaskLinc1) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `INT_EVENT0_IMASK_LINC1` reader - Enable LIN Capture 1 Interrupt."]
pub type IntEvent0ImaskLinc1R = crate::BitReader<IntEvent0ImaskLinc1>;
impl IntEvent0ImaskLinc1R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> IntEvent0ImaskLinc1 {
        match self.bits {
            false => IntEvent0ImaskLinc1::IntEvent0ImaskLinc1Clr,
            true => IntEvent0ImaskLinc1::IntEvent0ImaskLinc1Set,
        }
    }
    #[doc = "CLR"]
    #[inline(always)]
    pub fn is_int_event0_imask_linc1_clr(&self) -> bool {
        *self == IntEvent0ImaskLinc1::IntEvent0ImaskLinc1Clr
    }
    #[doc = "SET"]
    #[inline(always)]
    pub fn is_int_event0_imask_linc1_set(&self) -> bool {
        *self == IntEvent0ImaskLinc1::IntEvent0ImaskLinc1Set
    }
}
#[doc = "Field `INT_EVENT0_IMASK_LINC1` writer - Enable LIN Capture 1 Interrupt."]
pub type IntEvent0ImaskLinc1W<'a, REG> = crate::BitWriter<'a, REG, IntEvent0ImaskLinc1>;
impl<'a, REG> IntEvent0ImaskLinc1W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "CLR"]
    #[inline(always)]
    pub fn int_event0_imask_linc1_clr(self) -> &'a mut crate::W<REG> {
        self.variant(IntEvent0ImaskLinc1::IntEvent0ImaskLinc1Clr)
    }
    #[doc = "SET"]
    #[inline(always)]
    pub fn int_event0_imask_linc1_set(self) -> &'a mut crate::W<REG> {
        self.variant(IntEvent0ImaskLinc1::IntEvent0ImaskLinc1Set)
    }
}
#[doc = "Enable LIN Hardware Counter Overflow Interrupt.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum IntEvent0ImaskLinovf {
    #[doc = "0: CLR"]
    IntEvent0ImaskLinovfClr = 0,
    #[doc = "1: SET"]
    IntEvent0ImaskLinovfSet = 1,
}
impl From<IntEvent0ImaskLinovf> for bool {
    #[inline(always)]
    fn from(variant: IntEvent0ImaskLinovf) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `INT_EVENT0_IMASK_LINOVF` reader - Enable LIN Hardware Counter Overflow Interrupt."]
pub type IntEvent0ImaskLinovfR = crate::BitReader<IntEvent0ImaskLinovf>;
impl IntEvent0ImaskLinovfR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> IntEvent0ImaskLinovf {
        match self.bits {
            false => IntEvent0ImaskLinovf::IntEvent0ImaskLinovfClr,
            true => IntEvent0ImaskLinovf::IntEvent0ImaskLinovfSet,
        }
    }
    #[doc = "CLR"]
    #[inline(always)]
    pub fn is_int_event0_imask_linovf_clr(&self) -> bool {
        *self == IntEvent0ImaskLinovf::IntEvent0ImaskLinovfClr
    }
    #[doc = "SET"]
    #[inline(always)]
    pub fn is_int_event0_imask_linovf_set(&self) -> bool {
        *self == IntEvent0ImaskLinovf::IntEvent0ImaskLinovfSet
    }
}
#[doc = "Field `INT_EVENT0_IMASK_LINOVF` writer - Enable LIN Hardware Counter Overflow Interrupt."]
pub type IntEvent0ImaskLinovfW<'a, REG> = crate::BitWriter<'a, REG, IntEvent0ImaskLinovf>;
impl<'a, REG> IntEvent0ImaskLinovfW<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "CLR"]
    #[inline(always)]
    pub fn int_event0_imask_linovf_clr(self) -> &'a mut crate::W<REG> {
        self.variant(IntEvent0ImaskLinovf::IntEvent0ImaskLinovfClr)
    }
    #[doc = "SET"]
    #[inline(always)]
    pub fn int_event0_imask_linovf_set(self) -> &'a mut crate::W<REG> {
        self.variant(IntEvent0ImaskLinovf::IntEvent0ImaskLinovfSet)
    }
}
...
impl R {
    ...
    #[inline(always)]
    pub fn int_event0_imask_linc0(&self) -> IntEvent0ImaskLinc0R {
        IntEvent0ImaskLinc0R::new(((self.bits >> 7) & 1) != 0)
    }
    #[doc = "Bit 8 - Enable LIN Capture 1 Interrupt."]
    #[inline(always)]
    pub fn int_event0_imask_linc1(&self) -> IntEvent0ImaskLinc1R {
        IntEvent0ImaskLinc1R::new(((self.bits >> 8) & 1) != 0)
    }
    #[doc = "Bit 9 - Enable LIN Hardware Counter Overflow Interrupt."]
    #[inline(always)]
    pub fn int_event0_imask_linovf(&self) -> IntEvent0ImaskLinovfR {
        IntEvent0ImaskLinovfR::new(((self.bits >> 9) & 1) != 0)
    }
...
impl W {
    ...
    #[doc = "Bit 7 - Enable LIN Capture 0 / Match Interrupt ."]
    #[inline(always)]
    pub fn int_event0_imask_linc0(&mut self) -> IntEvent0ImaskLinc0W<IntEvent0ImaskSpec> {
        IntEvent0ImaskLinc0W::new(self, 7)
    }
    #[doc = "Bit 8 - Enable LIN Capture 1 Interrupt."]
    #[inline(always)]
    pub fn int_event0_imask_linc1(&mut self) -> IntEvent0ImaskLinc1W<IntEvent0ImaskSpec> {
        IntEvent0ImaskLinc1W::new(self, 8)
    }
    #[doc = "Bit 9 - Enable LIN Hardware Counter Overflow Interrupt."]
    #[inline(always)]
    pub fn int_event0_imask_linovf(&mut self) -> IntEvent0ImaskLinovfW<IntEvent0ImaskSpec> {
        IntEvent0ImaskLinovfW::new(self, 9)
    }
    #[doc = "Bit 10 - Enable UART Receive Interrupt."]
    #[inline(always)]
