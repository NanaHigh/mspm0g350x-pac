...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum IntEvent0IclrLinc0 {
    #[doc = "0: NO_EFFECT"]
    IntEvent0IclrLinc0NoEffect = 0,
    #[doc = "1: CLR"]
    IntEvent0IclrLinc0Clr = 1,
}
impl From<IntEvent0IclrLinc0> for bool {
    #[inline(always)]
    fn from(variant: IntEvent0IclrLinc0) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `INT_EVENT0_ICLR_LINC0` writer - Clear LIN Capture 0 / Match Interrupt ."]
pub type IntEvent0IclrLinc0W<'a, REG> = crate::BitWriter<'a, REG, IntEvent0IclrLinc0>;
impl<'a, REG> IntEvent0IclrLinc0W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "NO_EFFECT"]
    #[inline(always)]
    pub fn int_event0_iclr_linc0_no_effect(self) -> &'a mut crate::W<REG> {
        self.variant(IntEvent0IclrLinc0::IntEvent0IclrLinc0NoEffect)
    }
    #[doc = "CLR"]
    #[inline(always)]
    pub fn int_event0_iclr_linc0_clr(self) -> &'a mut crate::W<REG> {
        self.variant(IntEvent0IclrLinc0::IntEvent0IclrLinc0Clr)
    }
}
#[doc = "Clear LIN Capture 1 Interrupt.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum IntEvent0IclrLinc1 {
    #[doc = "0: NO_EFFECT"]
    IntEvent0IclrLinc1NoEffect = 0,
    #[doc = "1: CLR"]
    IntEvent0IclrLinc1Clr = 1,
}
impl From<IntEvent0IclrLinc1> for bool {
    #[inline(always)]
    fn from(variant: IntEvent0IclrLinc1) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `INT_EVENT0_ICLR_LINC1` writer - Clear LIN Capture 1 Interrupt."]
pub type IntEvent0IclrLinc1W<'a, REG> = crate::BitWriter<'a, REG, IntEvent0IclrLinc1>;
impl<'a, REG> IntEvent0IclrLinc1W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "NO_EFFECT"]
    #[inline(always)]
    pub fn int_event0_iclr_linc1_no_effect(self) -> &'a mut crate::W<REG> {
        self.variant(IntEvent0IclrLinc1::IntEvent0IclrLinc1NoEffect)
    }
    #[doc = "CLR"]
    #[inline(always)]
    pub fn int_event0_iclr_linc1_clr(self) -> &'a mut crate::W<REG> {
        self.variant(IntEvent0IclrLinc1::IntEvent0IclrLinc1Clr)
    }
}
#[doc = "Clear LIN Hardware Counter Overflow Interrupt.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum IntEvent0IclrLinovf {
    #[doc = "0: NO_EFFECT"]
    IntEvent0IclrLinovfNoEffect = 0,
    #[doc = "1: CLR"]
    IntEvent0IclrLinovfClr = 1,
}
impl From<IntEvent0IclrLinovf> for bool {
    #[inline(always)]
    fn from(variant: IntEvent0IclrLinovf) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `INT_EVENT0_ICLR_LINOVF` writer - Clear LIN Hardware Counter Overflow Interrupt."]
pub type IntEvent0IclrLinovfW<'a, REG> = crate::BitWriter<'a, REG, IntEvent0IclrLinovf>;
impl<'a, REG> IntEvent0IclrLinovfW<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "NO_EFFECT"]
    #[inline(always)]
    pub fn int_event0_iclr_linovf_no_effect(self) -> &'a mut crate::W<REG> {
        self.variant(IntEvent0IclrLinovf::IntEvent0IclrLinovfNoEffect)
    }
    #[doc = "CLR"]
    #[inline(always)]
    pub fn int_event0_iclr_linovf_clr(self) -> &'a mut crate::W<REG> {
        self.variant(IntEvent0IclrLinovf::IntEvent0IclrLinovfClr)
    }
}
...
impl W {
    ...
    #[inline(always)]
    pub fn int_event0_iclr_linc0(&mut self) -> IntEvent0IclrLinc0W<IntEvent0IclrSpec> {
        IntEvent0IclrLinc0W::new(self, 7)
    }
    #[doc = "Bit 8 - Clear LIN Capture 1 Interrupt."]
    #[inline(always)]
    pub fn int_event0_iclr_linc1(&mut self) -> IntEvent0IclrLinc1W<IntEvent0IclrSpec> {
        IntEvent0IclrLinc1W::new(self, 8)
    }
    #[doc = "Bit 9 - Clear LIN Hardware Counter Overflow Interrupt."]
    #[inline(always)]
    pub fn int_event0_iclr_linovf(&mut self) -> IntEvent0IclrLinovfW<IntEvent0IclrSpec> {
        IntEvent0IclrLinovfW::new(self, 9)
    }
