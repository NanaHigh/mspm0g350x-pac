...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum IntEvent0RisLinc0 {
    #[doc = "0: CLR"]
    IntEvent0RisLinc0Clr = 0,
    #[doc = "1: SET"]
    IntEvent0RisLinc0Set = 1,
}
impl From<IntEvent0RisLinc0> for bool {
    #[inline(always)]
    fn from(variant: IntEvent0RisLinc0) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `INT_EVENT0_RIS_LINC0` reader - LIN Capture 0 / Match Interrupt ."]
pub type IntEvent0RisLinc0R = crate::BitReader<IntEvent0RisLinc0>;
impl IntEvent0RisLinc0R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> IntEvent0RisLinc0 {
        match self.bits {
            false => IntEvent0RisLinc0::IntEvent0RisLinc0Clr,
            true => IntEvent0RisLinc0::IntEvent0RisLinc0Set,
        }
    }
    #[doc = "CLR"]
    #[inline(always)]
    pub fn is_int_event0_ris_linc0_clr(&self) -> bool {
        *self == IntEvent0RisLinc0::IntEvent0RisLinc0Clr
    }
    #[doc = "SET"]
    #[inline(always)]
    pub fn is_int_event0_ris_linc0_set(&self) -> bool {
        *self == IntEvent0RisLinc0::IntEvent0RisLinc0Set
    }
}
#[doc = "LIN Capture 1 Interrupt.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum IntEvent0RisLinc1 {
    #[doc = "0: CLR"]
    IntEvent0RisLinc1Clr = 0,
    #[doc = "1: SET"]
    IntEvent0RisLinc1Set = 1,
}
impl From<IntEvent0RisLinc1> for bool {
    #[inline(always)]
    fn from(variant: IntEvent0RisLinc1) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `INT_EVENT0_RIS_LINC1` reader - LIN Capture 1 Interrupt."]
pub type IntEvent0RisLinc1R = crate::BitReader<IntEvent0RisLinc1>;
impl IntEvent0RisLinc1R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> IntEvent0RisLinc1 {
        match self.bits {
            false => IntEvent0RisLinc1::IntEvent0RisLinc1Clr,
            true => IntEvent0RisLinc1::IntEvent0RisLinc1Set,
        }
    }
    #[doc = "CLR"]
    #[inline(always)]
    pub fn is_int_event0_ris_linc1_clr(&self) -> bool {
        *self == IntEvent0RisLinc1::IntEvent0RisLinc1Clr
    }
    #[doc = "SET"]
    #[inline(always)]
    pub fn is_int_event0_ris_linc1_set(&self) -> bool {
        *self == IntEvent0RisLinc1::IntEvent0RisLinc1Set
    }
}
#[doc = "LIN Hardware Counter Overflow Interrupt.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum IntEvent0RisLinovf {
    #[doc = "0: CLR"]
    IntEvent0RisLinovfClr = 0,
    #[doc = "1: SET"]
    IntEvent0RisLinovfSet = 1,
}
impl From<IntEvent0RisLinovf> for bool {
    #[inline(always)]
    fn from(variant: IntEvent0RisLinovf) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `INT_EVENT0_RIS_LINOVF` reader - LIN Hardware Counter Overflow Interrupt."]
pub type IntEvent0RisLinovfR = crate::BitReader<IntEvent0RisLinovf>;
impl IntEvent0RisLinovfR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> IntEvent0RisLinovf {
        match self.bits {
            false => IntEvent0RisLinovf::IntEvent0RisLinovfClr,
            true => IntEvent0RisLinovf::IntEvent0RisLinovfSet,
        }
    }
    #[doc = "CLR"]
    #[inline(always)]
    pub fn is_int_event0_ris_linovf_clr(&self) -> bool {
        *self == IntEvent0RisLinovf::IntEvent0RisLinovfClr
    }
    #[doc = "SET"]
    #[inline(always)]
    pub fn is_int_event0_ris_linovf_set(&self) -> bool {
        *self == IntEvent0RisLinovf::IntEvent0RisLinovfSet
    }
}
...
impl R {
    ...
    #[inline(always)]
    pub fn int_event0_ris_linc0(&self) -> IntEvent0RisLinc0R {
        IntEvent0RisLinc0R::new(((self.bits >> 7) & 1) != 0)
    }
    #[doc = "Bit 8 - LIN Capture 1 Interrupt."]
    #[inline(always)]
    pub fn int_event0_ris_linc1(&self) -> IntEvent0RisLinc1R {
        IntEvent0RisLinc1R::new(((self.bits >> 8) & 1) != 0)
    }
    #[doc = "Bit 9 - LIN Hardware Counter Overflow Interrupt."]
    #[inline(always)]
    pub fn int_event0_ris_linovf(&self) -> IntEvent0RisLinovfR {
        IntEvent0RisLinovfR::new(((self.bits >> 9) & 1) != 0)
    }
