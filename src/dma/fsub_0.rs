...
#[doc = "Field `FSUB_0_CHANID` reader - 0 = disconnected. 1-255 = connected to channelID = CHANID."]
...
#[doc = "Field `FSUB_0_CHANID` writer - 0 = disconnected. 1-255 = connected to channelID = CHANID."]
