...
#[doc = "Field `FSUB_1_CHANID` reader - 0 = disconnected. 1-255 = connected to channelID = CHANID."]
...
#[doc = "Field `FSUB_1_CHANID` writer - 0 = disconnected. 1-255 = connected to channelID = CHANID."]
