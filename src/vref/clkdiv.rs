...
#[doc = "Field `CLKDIV_RATIO` reader - Selects divide ratio of module clock to be used in sample and hold logic"]
pub type ClkdivRatioR = crate::FieldReader;
#[doc = "Field `CLKDIV_RATIO` writer - Selects divide ratio of module clock to be used in sample and hold logic"]
pub type ClkdivRatioW<'a, REG> = crate::FieldWriter<'a, REG, 3>;
impl R {
