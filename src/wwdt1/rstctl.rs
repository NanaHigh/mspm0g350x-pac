...
#[doc = "Field `RSTCTL_RESETASSERT` writer - Assert reset to the peripheral Note: For safety devices a watchdog reset by software is not possible."]
...
#[doc = "Field `RSTCTL_RESETSTKYCLR` writer - Clear \\[GPRCM.STAT.RESETSTKY\\]"]
